...
scenario('PR-9436: Check the taxes of "Denmark" country', () => {
  ...
  scenario('Check the availability of taxes for Denmark', client => {
    ...
    test('should check that the "Rate" of available tax for "Denmark" is equal to "25.000%"', () => client.checkTextValue(TaxesPage.tax_rate.replace('%S', 1), '25.000 %', 'equal', 2000) );
  }, 'common_client');
